...
import { ImageCarousel } from "../loadableImage/imageCarousel";
...
export const MovieCardCarouselItem = ({ movie}: MovieCarouselProps) => {
  ...
  return (
    <div className="md:relative">
      ...
      <div className="m-[20px] flex flex-col gap-[16px] md:absolute bottom-[30px] left-[148px] md:w-[404px] md:flex ">
